            ...
            <form className=''>
                ...
                <div className='w-[760px]  mx-auto'>
                    <div className='grid grid-cols-1 lg:grid-cols-2 gap-4'>
                        ...
                        <input name='lastName' type="text" placeholder='Last Name' className='input bg-base-100 input-ghost w-full  input-bordered' />
                        <input name='email' type="email" placeholder='Your Email' className='input bg-base-100 input-ghost w-full input-bordered' />
                        <input name='phone' type="text" placeholder='Phone Number' className='input bg-base-100 input-ghost w-full  input-bordered' />
                    </div>
