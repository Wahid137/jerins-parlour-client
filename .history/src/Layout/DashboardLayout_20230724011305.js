            ...
            <div className="drawer lg:drawer-open">
                ...
                <div className="drawer-side">
                    ...
                    <ul className="menu p-4 w-80 h-full text-base-content">
                        ...
                        {
                            isAdmin ? <>
                                <li><Link to="/dashboard/orderlist"><img className="w-5 ms-2" src={bookingList} alt="booking list" />Order List</Link></li>
                                <li><Link to="/dashboard/addservice"><img className="w-5 ms-2" src={add} alt="booking list" />Add service</Link></li>
