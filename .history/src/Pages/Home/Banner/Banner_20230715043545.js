    ...
    return (
        <div className="hero" >
            <div className="hero-content flex-col lg:flex-row-reverse min-h-screen">
                <img src={woman} className="rounded-lg -mt-48 ms-10lg:w-1/2 W-[484px] h-[478px]" alt="" />
                <div className='me-60 -mt-48'>
                    <h1 className="text-6xl font-bold mb-5">BEAUTY SALON</h1>
                    <h1 className="text-6xl font-bold mb-5">FOR EVERY WOMAN</h1>
