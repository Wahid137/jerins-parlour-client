...
const Banner = () => {
    return (
        <div className="hero" >
            ...
            <div className="hero-content flex-col lg:flex-row-reverse justify-between min-h-screen">
                <img src={woman} className="rounded-lg -mt-48 lg:w-1/2 W-[484px] h-[478px]" alt="" />
                <div className=''>
