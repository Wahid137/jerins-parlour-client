...
const Banner = () => {
    return (
        <div className="hero p-[0px]" >
            <div className="hero-content w-[1440px] p-[0px] flex-col lg:flex-row-reverse min-h-screen">

                <img src={woman} className="rounded-lg lg:w-1/2 W-[484px] h-[478px] mt-[0px]" alt="" />
