...
const SignUp = () => {
    ...
    return (
        <div className="flex justify-center items-center p-10">
            <div className='card'>
                <form className="border border-black w-[570px] p-20" onSubmit={handleSubmit(handleSignUp)}>
                    <h2 className='text-xl font-bold mb-10'>Create an account</h2>
                    ...
                    <p className='text-center mb-5'>Already have an Account? <Link to="/login" className='text-primary'>Please Login</Link></p>
                    <div>
