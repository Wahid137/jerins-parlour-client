...
import { FcGoogle, FcFacebook, AiFillFacebook } from 'react-icons/fc';
...
const SignUp = () => {
    ...
    return (
        <div className="flex justify-center items-center p-10 ">
            <div className='card'>
                <form className="border border-black w-[570px] p-12 pb-5" onSubmit={handleSubmit(handleSignUp)}>
                ...
                <div className='px-10'>
                    <button className='btn btn-outline hover:bg-primary rounded-3xl w-full'><AiFillFacebook className='w-10 h-5'></AiFillFacebook> CONTINUE WITH FACEBOOK</button>
                </div>
                <div className='px-10'>
