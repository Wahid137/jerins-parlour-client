            ...
            <form className='grid grid-cols-1 gap-3 mt-10 w-[570px]'>
                ...
                <div className='flex ms-2 my-5'>
                    <div className="items-center flex me-20">
                        <input type="radio" value="creditCard" onChange={e => setPaymentType(e.target.value)} name="creditCard" className="radio checked:bg-black" />
                        <img src={creditCard} alt="" className='w-8 ms-5' />
                        <span className="label-text">Credit Card</span>

                    </div>
                    <div className="items-center flex">
                        <input type="radio" value="paypal" onChange={e => setPaymentType(e.target.value)} name="paypal" className="radio checked:bg-black" />
